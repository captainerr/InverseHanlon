...
pubDate: 2026-07-24
tags: ["bitcoin", "bitcoin", "macro", "build-in-public"]
draft: false
---

Bitcoin is down about 30% on the year. It hit a low near $58,190 in June and is currently grinding sideways in the mid-$60,000s. 2026 became the [first calendar year with net-negative spot ETF flows](https://www.kucoin.com/news/flash/us-spot-bitcoin-etfs-record-4-1b-in-outflows-in-june-2026) since the funds launched in January 2024. Most people aren't writing bullish articles right now, but here I am...
...
- April 2024: [block reward dropped from 6.25 to 3.125 BTC](https://bitbo.io/calendar/2024-halving/) at [block height 840,000](https://www.coingecko.com/en/coins/bitcoin/bitcoin-halving)
- April 2028: scheduled drop to 1.5625 BTC at block height 1,050,000
- Total supply cap: 21 million, with [over 94% already mined](https://www.coingecko.com/en/coins/bitcoin/bitcoin-halving)
...
1. After the 2012 halving, Bitcoin rose [roughly 5,200%](https://www.kucoin.com/learn/crypto/bitcoin-halving-countdown)
2. After the 2016 halving, roughly 315%
3. After the 2020 halving, roughly 230%
...
On July 21, 2026, long-term holder supply hit a [fresh all-time high of 16.64 million BTC](https://news.bitcoin.com/bitcoin-long-term-holder-supply-all-time-high-2026/), about 83% of circulating supply on CoinGlass's methodology. Long-term holders are wallets that haven't moved coins in at least 155 days, a threshold [Glassnode](https://docs.glassnode.com/guides-and-tutorials/metric-guides/long-and-short-term-holder-supply/supply-held-by-long-and-short-term-holders) uses as a proxy for conviction rather than new demand. Trackers put the share anywhere from 75% to 83% depending on when they measured and how they define the cohort. They agree on the direction.
...
- [K33 Research](https://cryptobriefing.com/bitcoin-long-term-holders-79-percent-supply/) found only 218,421 BTC of two-year-dormant coins had been reactivated by June 6, 2026, the lowest old-coin movement since 2012
...
One caveat worth keeping. [CEX.IO](https://blog.cex.io/ecosystem/bitcoin-impact-index-week-22-2026-35616) notes that long-term holder supply usually sets new highs in the middle of a bear market, not the end, and that the accumulation pace has been slowing. Record conviction is a floor-building signal, not a starting gun.
...
The numbers are real, and they cut both ways. US spot Bitcoin ETFs have pulled in [roughly $58.72 billion in cumulative net inflows](https://nftplazas.com/bitcoin-etf-statistics-2026-15-key-data-points/) since their January 2024 launch and briefly crossed $100 billion in total assets. Then 2026 delivered the worst stretch on record: June alone saw [$4.06 billion in net outflows](https://www.kucoin.com/news/flash/us-spot-bitcoin-etfs-record-4-1b-in-outflows-in-june-2026), and total assets under management fell to around $73 billion by month-end.

It's durable because the mechanism survived a real test:

1. ETF flows are mechanical, not emotional; funds buy and sell on mandates, not sentiment, which means outflows are orderly rather than a stampede
2. Custody has matured enough that institutions no longer have to explain to their compliance department what a seed phrase is
3. As of mid-July 2026, ETFs had strung together [six consecutive sessions of inflows totaling around $930 million](https://www.benzinga.com/crypto/cryptocurrency/26/07/60604729/), their longest streak since April
...
- Regulatory drift. [Grayscale and Galaxy Digital](https://en.bloomingbit.io/feed/news/115345) have warned that delays in passing the Clarity Act could trigger further deleveraging and price declines. Regulatory uncertainty is already weighing on demand.
