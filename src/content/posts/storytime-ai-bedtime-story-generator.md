...
Total build time was an afternoon, most of which was fighting with Cloudflare's dashboard rather than writing code. That's the whole point of a project like this — it doesn't need to be more than it is.
