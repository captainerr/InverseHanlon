...
* what does a soft fork optimizes for? *
...
Pick one. Urgency and modesty do not usually travel together, and when a proposal insists on both, the honest move is to stop reading the manifesto and start reading the mechanism.

## The goal is the sympathetic part
...
BIP-110 is a one year temporary soft fork, formerly BIP-444, shipped as a fork of Bitcoin Knots. It activates as a UASF: nodes running the client reject blocks from miners who have not signaled, rather than miners rejecting invalid blocks among themselves. The lock-in threshold is 55%.

Segwit and Taproot, changes with vastly broader buy in, used a 95% signaling threshold under BIP9. 95% percent is what you require when your priority is that nobody meaningful is left on the wrong side of the chain. 55%  is what you require when your priority is winning.

The gap between those two numbers is not a rounding error. It is a decision about how many people you are willing to strand. At 95%, a split is a remote accident. At 55%, a 45% minority can keep mining a chain that your nodes now refuse and a chain split stops being a risk you tolerate and instead becomes the shape you designed.

## The inverse of the charitable read
...
That is the inversion. Do not attribute to sloppy governance what is better explained by a faction that would rather win a fork on its own terms than lose a vote on everyone else’s.

## The part nobody wants to say out loud

The people cheering this are, in many cases, the same people who spent 2017 warning that contentious forks are how you get scammed into a splinter chain with no replay protection. SegWit2X got within about a month of splitting the network before it was called off. The lesson everyone claimed to learn was that you do not force a contested change through a low bar and hope the minority folds.
